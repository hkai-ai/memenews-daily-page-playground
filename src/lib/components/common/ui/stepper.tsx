...
// 这个项目貌似break了
// ref: https://shadcn-stepper.vercel.app/
...
interface StepperProps extends StepOptions {
  ...
  initialStep: number
  steps: StepItem[]
  stepBtnContainerClassname?: string
}
...
interface StepSharedProps extends StepProps {
  ...
  isLoading?: boolean
  stepBtnContainerClassname?: string
  onClickStepGeneral?: (step: number, setStep: (step: number) => void) => void
}
...
const Step = React.forwardRef<HTMLLIElement, StepProps>(
  (props, ref: React.Ref<any>) => {
    ...
    const sharedProps = {
      ...
      state,
      errorIcon,
      onClickStep: disabled ? undefined : onClickStep,
      onClickStepGeneral,
      disabled,
    }
  ...
  (props, ref) => {
    ...
    return (
      <div
        ...
        onClick={() => !props.disabled && onClickStep?.(index || 0, setStep)}
      >
        <div
          data-vertical={true}
          data-active={active}
  ...
  (props, ref) => {
    ...
    return (
      <div
        ...
        onClick={() => !disabled && onClickStep?.(index || 0, setStep)}
      >
        <div
          className={cn(
  ...
  return (
    <Button
      ...
      className={cn(
        ...
        "data-[current=true]:scale-110 data-[current=true]:border-blue-500 data-[current=true]:bg-blue-500 data-[current=true]:text-primary-foreground data-[current=true]:shadow-[0_0_0_4px_rgba(59,130,246,0.3)] dark:data-[current=true]:text-primary",
